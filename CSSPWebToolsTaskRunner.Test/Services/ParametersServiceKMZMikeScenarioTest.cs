...
namespace CSSPWebToolsTaskRunner.Test.Services
{
    ...
    public class ParameterServiceKMLMikeScenarioTest
    {
        ...
        //10371	336925	336925	19	2	1	|||TVItemID,336925|||ReportTypeID,30|||ContourValues,14 88|||	1	2018-02-12 14:25:06.863	NULL NULL    NULL	2018-02-12 14:25:07.663	2
        [TestMethod]
        public void FillElementLayerList_Test()
        {
            foreach (LanguageEnum LanguageRequest in new List<LanguageEnum>() { LanguageEnum.en, LanguageEnum.fr })
            {
                ...
                int MikeScenarioTVItemID = 336925;
                int ReportTypeID = 30;
                ...
                bool retBool = parameterService.FillRequiredList(dfsuFile, elementLayerList, elementList, nodeList, topNodeLayerList, bottomNodeLayerList);
                Assert.AreEqual(true, retBool);
                Assert.AreEqual(11297, nodeList.Count);
                Assert.AreEqual(15260, elementLayerList.Count);
                Assert.AreEqual(15260, elementList.Count);
