...
namespace GeneratedCode
{
    public class GeneratedClass2
    {
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            WorkbookView workbookView1 = new WorkbookView() { XWindow = 120, YWindow = 150, WindowWidth = (UInt32Value)25035U, WindowHeight = (UInt32Value)12075U };
        ...
        private void GenerateWorksheetPart2Content(WorksheetPart worksheetPart2)
        {
            ...
            SheetFormatProperties sheetFormatProperties2 = new SheetFormatProperties() { DefaultRowHeight = 15D, DyDescent = 0.2D };
        ...
        private void GenerateWorksheetPart3Content(WorksheetPart worksheetPart3)
        {
            ...
            SheetDimension sheetDimension3 = new SheetDimension() { Reference = "A1:B1" };

            SheetViews sheetViews3 = new SheetViews();

            SheetView sheetView3 = new SheetView() { TabSelected = true, WorkbookViewId = (UInt32Value)0U };
            Selection selection1 = new Selection() { ActiveCell = "B1", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "B1" } };

            sheetView3.Append(selection1);

            sheetViews3.Append(sheetView3);
            SheetFormatProperties sheetFormatProperties3 = new SheetFormatProperties() { DefaultRowHeight = 15D, DyDescent = 0.2D };

            SheetData sheetData3 = new SheetData();

            Row row1 = new Row() { RowIndex = (UInt32Value)1U, Spans = new ListValue<StringValue>() { InnerText = "1:2" }, Height = 30D, DyDescent = 0.2D };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2015-07-28T15:55:25Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2015-07-28T15:56:02Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
