...
namespace CSSPWebToolsTaskRunner.Services
{
    public partial class ParametersService
    {
        private bool GenerateHTMLSubsectorFullReportCoverPage(FileInfo fi, StringBuilder sbHTML, string parameters, ReportTypeModel reportTypeModel)
        {
            ...
            sbHTML.AppendLine($@"        <td>|||Image|FileName,{ fiFullReportCoverPageImageCanadaFlag.FullName }|width,100|height,60|||</td> ");
            ...
            sbHTML.AppendLine($@" <table border=""0"">");
            sbHTML.AppendLine($@"    <tr>");
            sbHTML.AppendLine($@"        <td class=""textAlignLeft"">|||Image|FileName,{ fiFullReportCoverPageImageCanadaBanner.FullName }|width,640|height,150|||</td>");
            sbHTML.AppendLine($@"    </tr>");
            sbHTML.AppendLine($@" </table>");
            ...
            sbHTML.AppendLine($@" </div>");
            sbHTML.AppendLine($@" <div class=""textAlignRight"">|||Image|FileName,{ fiFullReportCoverPageImageCanadaWithFlag.FullName }|width,100|height,60|||</div>");
