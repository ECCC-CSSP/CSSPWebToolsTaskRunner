...
{
    public class DocxServiceArea
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassAreaDocx _Docx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public DocxServiceArea(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Docx = new GeneratedClassAreaDocx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassAreaDocx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassAreaDocx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        {
            DocxBase.CurrentTitle = DocxServiceAreaRes.Title;
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            GenerateAreaDocument(document);

            mainDocumentPart1.Document = document;
        }
        private void GenerateAreaDocument(Document document)
        {
            Body body = new Body();
            ...
            if (!string.IsNullOrWhiteSpace(tvItemModelArea.Error))
            {
                ...
                DocxBase.AddRunWithCurrentParagraphStyle(paragraph, tvItemModelArea.Error);
            }
            ...
            URL = _TaskRunnerBaseService.GetUrlFromTVItem(tvItemModelArea);
            run = DocxBase.AddRunHyperlink(paragraph, URL, tvItemModelArea.TVText);
            ...
            foreach (TVItemModel tvItemModelSector in tvItemModelSectorList)
            {
                ...
                URL = _TaskRunnerBaseService.GetUrlFromTVItem(tvItemModelSector);
                run = DocxBase.AddRunHyperlink(paragraph, URL, tvItemModelSector.TVText);
                ...
                List<TVItemStatModel> tvItemStatModelList = tvItemStatService.GetTVItemStatModelListWithTVItemIDDB(tvItemModelSector.TVItemID);
