...
{
    public class XlsxServiceMunicipality
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassMunicipalityXlsx _Xlsx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public XlsxServiceMunicipality(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Xlsx = new GeneratedClassMunicipalityXlsx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassMunicipalityXlsx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassMunicipalityXlsx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        private void CreateParts(SpreadsheetDocument document)
        {
            ...
            XlsxBase.AddSheetNameAndID(baseEnumService.GetEnumText_TVTypeEnum(TVTypeEnum.Municipality));
        ...
        private void GenerateWorksheetAContent(WorksheetPart worksheetPart, int SheetOrdinal)
        {
            ...
            {
                //tvItemStatService.SetTVItemStatForTVItemIDAndParentsTVItemID(tvItemModelInfrastructure.TVItemID);
                ...
                row = XlsxBase.AddRow();
                string URL = _TaskRunnerBaseService.GetUrlFromTVItem(tvItemModelInfrastructure);
                XlsxBase.CurrentFontColor = System.Drawing.Color.Blue;
                cell = XlsxBase.AddCellHyperlink(hyperlinks, row, tvItemModelInfrastructure.TVText, URL);
                ...
                List<TVItemStatModel> tvItemStatModelList = tvItemStatService.GetTVItemStatModelListWithTVItemIDDB(tvItemModelInfrastructure.TVItemID);
