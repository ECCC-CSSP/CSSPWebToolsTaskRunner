...
//    {
//        private bool GenerateHTMLSUBSECTOR_MUNICIPALITY_WWTP_COLLECTION_SYSTEM_MAP(StringBuilder sbTemp)
//        {
//            int Percent = 10;
//            string NotUsed = "";

//            _TaskRunnerBaseService.SendPercentToDB(_TaskRunnerBaseService._BWObj.appTaskModel.AppTaskID, Percent);
//            _TaskRunnerBaseService.SendStatusTextToDB(_TaskRunnerBaseService.GetTextLanguageFormat1List("Creating_", ReportGenerateObjectsKeywordEnum.SUBSECTOR_MUNICIPALITY_WWTP_COLLECTION_SYSTEM_MAP.ToString()));
...
//                {
//                    sbTemp.AppendLine($@"<h3>{ tvItemModel.TVText } SUBSECTOR_MUNICIPALITY_WWTP_COLLECTION_SYSTEM_MAP</h3");
...
//        public bool PublicGenerateHTMLSUBSECTOR_MUNICIPALITY_WWTP_COLLECTION_SYSTEM_MAP(StringBuilder sbTemp)
//        {
//            bool retBool = GenerateHTMLSUBSECTOR_MUNICIPALITY_WWTP_COLLECTION_SYSTEM_MAP(sbTemp);
