...
{
    public class DocxServiceCountry
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassCountryDocx _Docx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public DocxServiceCountry(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Docx = new GeneratedClassCountryDocx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassCountryDocx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassCountryDocx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            GenerateCountryDocument(document);
