...
{
    public class DocxServiceMWQMPlan
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassMWQMPlanDocx _Docx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public DocxServiceMWQMPlan(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Docx = new GeneratedClassMWQMPlanDocx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassMWQMPlanDocx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassMWQMPlanDocx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        {
            DocxBase.CurrentTitle = DocxServiceMWQMPlanRes.Title;
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            GenerateMWQMPlanDocument(document);
