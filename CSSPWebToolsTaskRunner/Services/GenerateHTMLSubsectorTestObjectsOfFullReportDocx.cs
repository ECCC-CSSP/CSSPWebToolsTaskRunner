...
namespace CSSPWebToolsTaskRunner.Services
{
    ...
    {
        private bool GenerateHTMLSubsectorTestObjectsOfFullReportDocx()
        {
        ...
        private bool GenerateHTMLSubsectorFullReportCoverPageDocx()
        {
            _TaskRunnerBaseService.SendPercentToDB(_TaskRunnerBaseService._BWObj.appTaskModel.AppTaskID, 3);
        ...
        private bool GenerateHTMLSubsectorFullReportDocx()
        {
            _TaskRunnerBaseService.SendPercentToDB(_TaskRunnerBaseService._BWObj.appTaskModel.AppTaskID, 3);
        ...
        public bool PublicGenerateHTMLSubsectorTestObjectsOfFullReportDocx()
        {
            bool retBool = GenerateHTMLSubsectorTestObjectsOfFullReportDocx();
