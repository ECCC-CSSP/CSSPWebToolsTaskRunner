...
namespace CSSPWebToolsTaskRunner.Services
{
    ...
    {
        private bool GenerateHTMLSUBSECTOR_MWQM_SITES_NUMBER_OF_RUNS_BY_YEAR(StringBuilder sbTemp)
        {
            int Percent = 10;
            string NotUsed = "";

            _TaskRunnerBaseService.SendPercentToDB(_TaskRunnerBaseService._BWObj.appTaskModel.AppTaskID, Percent);
            _TaskRunnerBaseService.SendStatusTextToDB(_TaskRunnerBaseService.GetTextLanguageFormat1List("Creating_", ReportGenerateObjectsKeywordEnum.SUBSECTOR_MWQM_SITES_NUMBER_OF_RUNS_BY_YEAR.ToString()));
            ...
            sbTemp.AppendLine($@"|||FigureCaption|: { TaskRunnerServiceRes.NumberOfMWQMRunsByYear }|||");
        ...
        public bool PublicGenerateHTMLSUBSECTOR_MWQM_SITES_NUMBER_OF_RUNS_BY_YEAR(StringBuilder sbTemp)
        {
            bool retBool = GenerateHTMLSUBSECTOR_MWQM_SITES_NUMBER_OF_RUNS_BY_YEAR(sbTemp);
