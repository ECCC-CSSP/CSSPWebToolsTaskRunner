...
{
    public class DocxServiceSubsector
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassSubsectorDocx _Docx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public DocxServiceSubsector(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Docx = new GeneratedClassSubsectorDocx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassSubsectorDocx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassSubsectorDocx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            GenerateSubsectorDocument(document);

            mainDocumentPart1.Document = document;
        }
        private void GenerateSubsectorDocument(Document document)
        {
            Body body = new Body();
