...
{
    public class XlsxServiceRoot
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassRootXlsx _Xlsx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public XlsxServiceRoot(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Xlsx = new GeneratedClassRootXlsx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassRootXlsx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassRootXlsx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        private void GenerateWorksheetAContent(WorksheetPart worksheetPart, int SheetOrdinal)
        {
            ...
            foreach (TVItemModel tvItemModelCountry in tvItemModelCountryList)
            {
                ...
                row = XlsxBase.AddRow();
                string URL = _TaskRunnerBaseService.GetUrlFromTVItem(tvItemModelCountry);
                XlsxBase.CurrentFontColor = System.Drawing.Color.Blue;
                cell = XlsxBase.AddCellHyperlink(hyperlinks, row, tvItemModelCountry.TVText, URL);
