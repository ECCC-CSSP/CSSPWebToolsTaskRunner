...
namespace CSSPWebToolsTaskRunner.Services
{
    public class KmzServiceArea
    {
        ...
        #region Constructors
        public KmzServiceArea(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        public void Generate(FileInfo fi)
        {
            ...
            TVItemModel tvItemModelArea = tvItemService.GetTVItemModelWithTVItemIDDB(_TaskRunnerBaseService._BWObj.appTaskModel.TVItemID);
            List<MapInfoPointModel> mapInfoPointModelList = mapInfoService._MapInfoPointService.GetMapInfoPointModelListWithTVItemIDAndTVTypeAndMapInfoDrawTypeDB(tvItemModelArea.TVItemID, TVTypeEnum.Area, MapInfoDrawTypeEnum.Point);

            sbKMZ.AppendLine(@"	<Folder>");
            sbKMZ.AppendLine(@"	<name>Area</name>");
            ...
            sbKMZ.AppendLine(@"		" + (mapInfoPointModelList[0].Lng - 0.02) + "," + (mapInfoPointModelList[0].Lat - 0.02) + ",0");
            sbKMZ.AppendLine(@"		" + (mapInfoPointModelList[0].Lng + 0.02) + "," + (mapInfoPointModelList[0].Lat - 0.02) + ",0");
            sbKMZ.AppendLine(@"		" + (mapInfoPointModelList[0].Lng + 0.02) + "," + (mapInfoPointModelList[0].Lat + 0.02) + ",0");
            sbKMZ.AppendLine(@"		" + (mapInfoPointModelList[0].Lng - 0.02) + "," + (mapInfoPointModelList[0].Lat + 0.02) + ",0");
            sbKMZ.AppendLine(@"		" + (mapInfoPointModelList[0].Lng - 0.02) + "," + (mapInfoPointModelList[0].Lat - 0.02) + ",0");
            ...
            foreach (TVItemModel tvItemModelSector in tvItemModelSectorList)
            {
                // Doing point
                sbKMZ.AppendLine(@"	<Placemark>");
                sbKMZ.AppendLine(@"	<name>" + tvItemModelSector.TVText + "</name>");
                sbKMZ.AppendLine(@"<styleUrl>#msn_ylw-pushpin</styleUrl>");
                //sbKMZ.AppendLine(@"	<description>");
                //sbKMZ.AppendLine(@"<![CDATA[");
                ...
                mapInfoPointModelList = mapInfoService._MapInfoPointService.GetMapInfoPointModelListWithTVItemIDAndTVTypeAndMapInfoDrawTypeDB(tvItemModelSector.TVItemID, TVTypeEnum.Sector, MapInfoDrawTypeEnum.Point);
                ...
                // Doing Polygon
                sbKMZ.AppendLine(@"	<Placemark>");
                sbKMZ.AppendLine(@"		<name>" + tvItemModelSector.TVText + " (poly)</name>");
                sbKMZ.AppendLine(@"<styleUrl>#msn_ylw-pushpin</styleUrl>");
                //sbKMZ.AppendLine(@"	<description>");
                //sbKMZ.AppendLine(@"<![CDATA[");
                //sbKMZ.AppendLine(@"<a href=""" + _TaskRunnerBaseService.GetUrlFromTVItem(tvItemModelCountry) + @""">" + tvItemModelCountry.TVText + "</a>");
                ...
                mapInfoPointModelList = mapInfoService._MapInfoPointService.GetMapInfoPointModelListWithTVItemIDAndTVTypeAndMapInfoDrawTypeDB(tvItemModelSector.TVItemID, TVTypeEnum.Sector, MapInfoDrawTypeEnum.Polygon);
