...
namespace CSSPWebToolsTaskRunner.Services
{
    ...
    {
        private bool GenerateHTMLSUBSECTOR_POLLUTION_SOURCE_LOCATIONS_MAP(StringBuilder sbTemp)
        {
            int Percent = 10;
            string NotUsed = "";
            ...
            string StartText = $"{SubsectorTVText}_Pollution_Source_Locations_Map_";
            ...
            if (FileExist)
            {
                if (Year == FileYear)
                {
                    ...
                    sbTemp.AppendLine($@"<div>|||FigureCaption| { TaskRunnerServiceRes.PollutionSourceLocation }|||</div>");
                }
                else
                {
        ...
        public bool PublicGenerateHTMLSUBSECTOR_POLLUTION_SOURCE_LOCATIONS_MAP(StringBuilder sbTemp)
        {
            bool retBool = GenerateHTMLSUBSECTOR_POLLUTION_SOURCE_LOCATIONS_MAP(sbTemp);
