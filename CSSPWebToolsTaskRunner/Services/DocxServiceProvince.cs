...
{
    public class DocxServiceProvince
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassProvinceDocx _Docx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public DocxServiceProvince(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Docx = new GeneratedClassProvinceDocx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassProvinceDocx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassProvinceDocx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            GenerateProvinceDocument(document);

            mainDocumentPart1.Document = document;
        }
        private void GenerateProvinceDocument(Document document)
        {
            Body body = new Body();
            ...
            if (!string.IsNullOrWhiteSpace(tvItemModelProvince.Error))
            {
                ...
                DocxBase.AddRunWithCurrentParagraphStyle(paragraph, tvItemModelProvince.Error);
            }
