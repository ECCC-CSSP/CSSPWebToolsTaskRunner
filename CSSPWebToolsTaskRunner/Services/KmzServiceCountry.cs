...
{
    public class KmzServiceCountry
    {
        #region Variables
        ...
        #region Constructors
        public KmzServiceCountry(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        public void Generate(FileInfo fi)
        {
            ...
            List<MapInfoPointModel> mapInfoPointModelList = mapInfoService._MapInfoPointService.GetMapInfoPointModelListWithTVItemIDAndTVTypeAndMapInfoDrawTypeDB(tvItemModelCountry.TVItemID, TVTypeEnum.Country, MapInfoDrawTypeEnum.Point);

            sbKMZ.AppendLine(@"	<Folder>");
            sbKMZ.AppendLine(@"	<name>Country</name>");
            ...
            sbKMZ.AppendLine(@" <Folder>");
            sbKMZ.AppendLine(@"	<name>Provinces</name>");
            List<TVItemModel> tvItemModelProvinceList = tvItemService.GetChildrenTVItemModelListWithTVItemIDAndTVTypeDB(tvItemModelCountry.TVItemID, TVTypeEnum.Province);
            ...
            foreach (TVItemModel tvItemModelProvince in tvItemModelProvinceList)
            {
                ...
                mapInfoPointModelList = mapInfoService._MapInfoPointService.GetMapInfoPointModelListWithTVItemIDAndTVTypeAndMapInfoDrawTypeDB(tvItemModelProvince.TVItemID, TVTypeEnum.Province, MapInfoDrawTypeEnum.Point);
