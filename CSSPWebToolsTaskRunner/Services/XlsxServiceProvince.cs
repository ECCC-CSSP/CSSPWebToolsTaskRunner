...
{
    public class XlsxServiceProvince
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassProvinceXlsx _Xlsx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public XlsxServiceProvince(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Xlsx = new GeneratedClassProvinceXlsx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassProvinceXlsx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassProvinceXlsx(TaskRunnerBaseService taskRunnerBaseService)
        {
