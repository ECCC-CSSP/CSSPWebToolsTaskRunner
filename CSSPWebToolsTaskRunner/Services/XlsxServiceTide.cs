...
{
    public class XlsxServiceTide
    {
        #region Variables
        #endregion Variables

        #region Properties
        public GeneratedClassTideXlsx _Xlsx { get; set; }
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        #endregion Properties

        #region Constructors
        public XlsxServiceTide(TaskRunnerBaseService taskRunnerBaseService)
        {
            _TaskRunnerBaseService = taskRunnerBaseService;
            _Xlsx = new GeneratedClassTideXlsx(_TaskRunnerBaseService);
        }
    ...
    public class GeneratedClassTideXlsx
    {
        #region Properties
        public TaskRunnerBaseService _TaskRunnerBaseService { get; private set; }
        ...
        #region Constructors
        public GeneratedClassTideXlsx(TaskRunnerBaseService taskRunnerBaseService)
        {
        ...
        private void CreateParts(SpreadsheetDocument document)
        {
            ...
            XlsxBase.AddSheetNameAndID(baseEnumService.GetEnumText_TVTypeEnum(TVTypeEnum.TideSite));
        ...
        private void GenerateWorksheetAContent(WorksheetPart worksheetPart, int SheetOrdinal)
        {
            ...
            TVItemModel tvItemModelTide = tvItemService.GetTVItemModelWithTVItemIDDB(_TaskRunnerBaseService._BWObj.appTaskModel.TVItemID);

            List<TVItemModel> tvItemModelMunicipalityList = tvItemService.GetChildrenTVItemModelListWithTVItemIDAndTVTypeDB(tvItemModelTide.TVItemID, TVTypeEnum.Municipality);
